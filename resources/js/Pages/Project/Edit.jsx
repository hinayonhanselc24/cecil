...
export default function Create({auth, project }){
    ...
    return(
        <AuthenticatedLayout
        user={auth.user}
        header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Project {project.name}</h2>}>
            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div className="text-right mt-4">
                            <Link className="mt-4 text-white px-2 p-y rounded bg-gray-400 inline-block mr-2" href={route('project.index')}>Cancel</Link>
