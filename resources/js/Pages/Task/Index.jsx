...
export default function Index({auth, task, queryParams = null}) {
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    ...
                    <Link
                        className="mt-4 px-2 p-y rounded bg-blue-400 inline-block mr-2" href={route('task.create' ,task.id)} >Create new Task
                    </Link>
                </div>}>
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                ...
                                <tbody>
                                    ...
                                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={task.id}>
                                        ...
                                        <td className="px-3 py-2">
                                            <span className={"px-2 p-y rounded text-white " + TASK_STATUS_CLASS_MAP[task.status]}>
                                        ...
                                        <td>
                                            <p className="px-3 py-2 text-nowrap">
                        ...
                        {/* <pre className="text-white overflow-auto">{JSON.stringify(task)}</pre> */}
                    </div>
                </div>
            </div>
        </AuthenticatedLayout>
